...
public class SECTR_CharacterMotor : MonoBehaviour
{
    ...
    private PhysicsMaterial defaultHitMaterial;
#else
    ...
    public class CharacterMotorMovement
    {
		...
		[System.NonSerialized]
#if UNITY_6000_0_OR_NEWER
		public PhysicsMaterial hitMaterial = null;
#else
...
#if UNITY_6000_0_OR_NEWER
		defaultHitMaterial = new PhysicsMaterial();
#else
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
		...
		if(body != null && !body.isKinematic && hit.moveDirection.y >= -0.3f)
		{
            ...
            // Apply the push
#if UNITY_6000_0_OR_NEWER
			body.linearVelocity = pushDir * movement.pushPower;
#else
