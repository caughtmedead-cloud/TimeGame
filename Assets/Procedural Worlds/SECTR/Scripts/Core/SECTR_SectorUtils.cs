...
public class SECTR_SectorUtils : MonoBehaviour
{
	...
	{
		return SECTR_SectorUtils.FindObjectOfType<SECTR_Sector>() != null;
	}

	public static new T FindObjectOfType<T>() where T : UnityEngine.Object
	{
#if UNITY_6000_0_OR_NEWER
		return GameObject.FindFirstObjectByType(typeof(T)) as T;
#else
		return GameObject.FindObjectOfType(typeof(T)) as T;
#endif
    }

    public static new T[] FindObjectsOfType<T>() where T : UnityEngine.Object
    {
#if UNITY_6000_0_OR_NEWER
	...
	public static List<SECTR_Sector> GetTopLevelSectors()
	{
		...
		SECTR_Sector[] sectors = SECTR_SectorUtils.FindObjectsOfType<SECTR_Sector>();
	...
	private static GameObject GetGlobalParent(ref List<GameObject> newParents, Vector3 parentLocation, string[] hierarchy, bool mergeSpawns)
	{
		...
		foreach (var go in SECTR_SectorUtils.FindObjectsOfType<GameObject>())
		{
