...
public class SECTR_AudioWindow : SECTR_Window 
{
	...
	private void SetPreloadAudioData(AudioImporter importer, bool newPreload)
	{
		...
		if (importer.ContainsSampleSettingsOverride(EditorUserBuildSettings.selectedBuildTargetGroup.ToString()))
		{
			sampleSettings = importer.GetOverrideSampleSettings(EditorUserBuildSettings.selectedBuildTargetGroup.ToString());
	...
	private bool GetPreloadAudioDataSetting(AudioImporter importer)
	{
		if (importer.ContainsSampleSettingsOverride(EditorUserBuildSettings.selectedBuildTargetGroup.ToString()))
		{
			return importer.GetOverrideSampleSettings(EditorUserBuildSettings.selectedBuildTargetGroup.ToString()).preloadAudioData;
		}
