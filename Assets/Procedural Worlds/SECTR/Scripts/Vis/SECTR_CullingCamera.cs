...
#region Public Interface
    ...
    private void RenderPipeline_beginFrameRendering(ScriptableRenderContext context, List<Camera> list)
...
#if UNITY_2023_3_OR_NEWER
            RenderPipelineManager.beginContextRendering += RenderPipeline_beginFrameRendering;
#elif UNITY_2019_3_OR_NEWER
