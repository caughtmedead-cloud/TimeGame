...
namespace Inventory.Scripts.Core.Editor.Holders
{
    ...
    public class ItemHolderEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty(UniqueUid));
            ...
            DrawPropertiesExcluding(serializedObject, ScriptPropertyName, UniqueUid, UseDefaultSpritePropertyName,
                DefaultSpritePropertyName, SpriteColorPropertyName, DisplayRotatedIcon);
