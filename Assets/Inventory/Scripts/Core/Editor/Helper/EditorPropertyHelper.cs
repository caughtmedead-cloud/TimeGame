...
namespace Inventory.Scripts.Core.Editor.Helper
{
    ...
    {
        public static void AddScriptProperty(SerializedObject serializedObject)
        {
            AddScriptProperty(serializedObject.FindProperty("m_Script"));
        }

        private static void AddScriptProperty(SerializedProperty property)
        {
