...
namespace Inventory.Scripts.Core.Displays.Case
{
    ...
    [RequireComponent(typeof(HorizontalOrVerticalLayoutGroup), typeof(GridFiller))]
    public class ResidentEvilCaseDisplayFiller : DisplayFiller
    {
        ...
        protected override void OnSetDisplay()
        {
            base.OnSetDisplay();

            if (DisplayData is { ItemContainer: null })
            {
                return;
            }
        ...
        {
            var container = DisplayData.ItemContainer;
            ...
            var gridsInventory = containerMetadata.Inventories;
