...
namespace Inventory.Scripts.Core.ScriptableObjects.Items
{
    ...
    [JsonConverter(typeof(ItemDataSoConverter))]
    ...
    public class ItemDataSo : ScriptableObject
    {
        ...
        [SerializeField] private EnvironmentItemHolder prefab;
        ...
        public EnvironmentItemHolder Prefab => prefab;
        ...
        private void Awake()
        {
            StaticInventoryContext.AddItem(this);
        }
