...
namespace Inventory.Scripts.Editor
{
    public class InitializrInventoryEditor : EditorWindow
    {
        ...
        {
            StaticInventoryContext.InventorySettingsAnchorSo = inventorySettingsAnchorSo;
        ...
        {
            var inspectWindowManager = inventoryManager.GetComponentInChildren<WindowManager>();
