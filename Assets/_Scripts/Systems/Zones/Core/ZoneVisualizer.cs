...
public class ZoneVisualizer : VisualizerParent
{
    private const string GLOBAL_TEXT_VISIBILITY_KEY = "Zone_GlobalTextVisibility";
    private const string GLOBAL_PLAYMODE_VISIBILITY_KEY = "Zone_GlobalPlayModeVisibility";
    ...
    private void DrawTextLabel(Vector3 worldPosition, bool isSelected)
    {
        ...
        string zoneTypeInfo = zone.GetZoneTypeDescription();
